...
// Function to edit the employee data in the table
// when the user clicks the edit button of a specific employee data or row
// document.getElementById('btn-edit-employee').addEventListener('click', function(event) {
//     event.preventDefault();
